...
<div class="contedor">
  ...
  <div class="contenido">
    <button class="boton" id="btnMostrarTar">Nuevo</button>
    <div id="formTarDiv" style="display:none;">
      <form id="formTar" name="formTar">
        ...
        <button class="boton" type="submit" id="btnEnviarTar" name="btnEnviarTar">Crear</button>
        <button class="boton" type="reset" onClick="limpiar()">Limpiar</button>
      </form>
    </div>
    <div class="colorletratabla">
      <table id="tareas" name="tareas" class="tablas">
        <thead>
          <tr>
            <th>ID</th>
            <th>Descripción</th>
